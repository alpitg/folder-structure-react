...
export const RESET_FETCH_ROLE = "RESET_FETCH_ROLE";
...
export const CLEAN_UPDATE_ROLE_ERROR = "CLEAN_UPDATE_ROLE_ERROR";
...
export interface IResetFetchRole {
  type: typeof RESET_FETCH_ROLE;
}
...
export const resetFetchRole = (): IResetFetchRole => ({
  type: RESET_FETCH_ROLE,
});
