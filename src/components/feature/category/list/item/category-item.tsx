...
const CategoryItemApp = (props: { item: any, refreshList: any }) => {
        ...
        <>
            <div className="row pb-3">
                ...
                <div className="col-3 col-md-3">
                    <>
                        <Link to={`${ROUTE_URL.CATEGORY}/edit/${props?.item?.id}`}>
                        ...
                        <span
                            className="icon"
                            title="Delete"
                            onClick={() => deleteCategory(props?.item.id)}
                        >
...
export default CategoryItemApp;