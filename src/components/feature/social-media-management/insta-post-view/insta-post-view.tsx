...
import "./insta-post-view.scss";
import { useEffect, useState } from "react";
import { InstaSocialMediaContent } from "../../../../interfaces/social-media.model";

const InstaPostView = ({
  mediaContent,
}: {
  mediaContent: InstaSocialMediaContent;
}) => {
  ...
  useEffect(() => {
    if (mediaContent?.media_url) {
      setImageState(mediaContent.media_url ? mediaContent?.media_url : defaultImage);
    }
  }, [mediaContent]);

  return (
    <div className="insta-post-view-app">
      <Card>
        <div className="posts">
          <article className="post">
            <div className="post__header">
              <div className="post__profile">
                <img
                  ...
                  alt="profile-small"
                />
                <span className="post__user">{mediaContent?.username}</span>
              </div>

              <span className="pi pi-ellipsis-h pe-2"></span>
            </div>
            ...
            <div className="post__footer">
              <div className="post__buttons">
                <button className="post__button">
                  ...
                  >
                    <path
                      ...
                      fill="var(--insta-text-dark)"
                      stroke="var(--insta-text-dark)"
                      strokeWidth="0.6"
                    />
                  </svg>
                </button>
                ...
                <button className="post__button align__right">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <div className="post__infos">
                <div className="post__likes">
                  <span className="post__likes-avatar">
                    <img
                      className="media__pic__round xs__media__pic"
                      src={"static/media/img/default-user1.png"}
                      alt="profile-small"
                    />
                  </span>
                  ...
                  <span>
                    Liked by
                    <b> user123 </b> and
                    <b> {mediaContent?.like_count} others</b>
                  </span>
                </div>

                <div className="post__description">
                  <span>
                    <b>{mediaContent?.username} </b>
